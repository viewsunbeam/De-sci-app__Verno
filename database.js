...
const dbFile = process.env.SQLITE_DB_PATH
    ...
    : path.resolve(__dirname, 'desci.db');
...
const initializeDatabase = async () => {
    const sql = `
        CREATE TABLE IF NOT EXISTS users (
            ...
            user_role TEXT DEFAULT 'researcher',
    ...
    try {
        ...
        if (!columnNames.includes('user_role')) {
            await db.runAsync('ALTER TABLE users ADD COLUMN user_role TEXT DEFAULT "researcher"');
            console.log("Migration successful: Added 'user_role' column to 'users' table.");
        }
        ...
        const createActivityLogsTableSql = `
            CREATE TABLE IF NOT EXISTS activity_logs (
                ...
                username TEXT,
                wallet_address TEXT,
                action_type TEXT NOT NULL, -- 'create', 'update', 'delete', 'mint', 'login', 'upload', etc.
                resource_type TEXT NOT NULL, -- 'user', 'project', 'dataset', 'nft', 'review', etc.
                resource_id INTEGER,
                resource_name TEXT,
        ...
        `;
        await db.runAsync(createActivityLogsTableSql);
