        ...
        <div class="right-column">
          ...
          <n-card title="Statistics" class="content-card">
            <n-grid :cols="2" :x-gap="16" :y-gap="16">
              ...
              <n-gi>
                <n-statistic label="Downloads" :value="paper.downloadCount || 0" />
              </n-gi>
              <n-gi>
                <n-statistic label="Citations" :value="paper.citationCount || 0" />
              </n-gi>
              <n-gi>
...
const fetchPaper = async () => {
  try {
    ...
    const publicationId = route.params.paper_id
    ...
    paper.value = {
      ...
      authors: Array.isArray(publicationData.authors) 
        ? publicationData.authors.map(author => 
      ...
      license: 'cc-by', // Default license
      funding: '', // Not in DB yet
