<template>
  <div class="nft-detail-page">
          ...
          <div class="left-column">
            <div class="nft-image-card">
              <div class="nft-image-container">
                <img :src="getImageUrl(nft.image) || getDefaultImage(nft.title)" :alt="nft.title" class="nft-image" @error="handleImageError" />
    ...
    <!-- Error State -->
    <div v-if="!nft && !isLoading" class="error-state">
...
const getDefaultImage = (title) => {
  ...
  const svg = `<svg width="300" height="400" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="150" y="200" font-family="Arial, sans-serif" font-size="16" fill="#eee" text-anchor="middle">
      ${displayTitle}
    </text>
  </svg>`
...
const handleImageError = (event) => {
  console.warn('Image failed to load, using default placeholder')
  const img = event.target
  const title = img.alt || 'NFT'
  img.src = getDefaultImage(title)
}
